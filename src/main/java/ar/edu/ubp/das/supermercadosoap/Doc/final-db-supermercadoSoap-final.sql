...
select * from provincias_localidades
/* -------------------------------------
...
INSERT INTO dbo.sucursales (nro_sucursal, calle, nro_calle, telefonos, coord_latitud, coord_longitud, nro_localidad, habilitada) VALUES
(5, 'Donato Alvarez', 5443, '351-1234567', -31.4160, -64.1830, 1, 'S'),
(6, 'Av Boderear', 9855, '351-2345678', -31.3386, -64.3024, 2, 'S'),
(7, 'Rio de Janeiro', 1112, '351-3456789', -32.0667, -64.3000, 3, 'S'),
(8, 'Av. Miami', 00998, '351-4567890', -31.2946, -64.2777, 4, 'S');
...
delete from dbo.productos_sucursales where cod_barra = '1234567890140'; 
--sucursale 2
INSERT INTO dbo.productos_sucursales (nro_sucursal, cod_barra, precio, vigente) VALUES
